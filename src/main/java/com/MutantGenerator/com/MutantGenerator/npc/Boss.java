...
public class Boss extends NPC {
	...
	private static String role = "Boss";
	...
	private static String skill1 = "Kommendera FV 3";
	...
	public Boss() {
		...
		super(name, role, description, strenght, coolness, sharpness, feeling, skill1, skill2, skill3 , mutation, weapon, amunition, food,
				water);
